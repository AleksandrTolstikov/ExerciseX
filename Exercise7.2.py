...
name_short = {'имя', 'зовут'}
age_short = {'старше', 'младше'}
address_short = {'живет'}
...
class Person:
    ...
    def fuzzy_compare(self, query): # не был добавлен self в видео 
        q = set(query.split())
        score = 0
        for m, f in zip(
    ...
    def by_name(self, Q): # не был добавлен self в видео
         Q = Q - name_short
    ...
    def by_age(self, Q):# не был добавлен self в видео 
    ...
    def by_address(self, Q):# не был добавлен self в видео 
        Q = Q - address_short
